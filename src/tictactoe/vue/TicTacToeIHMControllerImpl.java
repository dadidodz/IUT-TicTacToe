...
public class TicTacToeIHMControllerImpl implements Initializable
{
    ...
    public void setMarque(final int ligne, final int colonne)
    {
                ...
                forEachOrdered((node) -> 
        {
            ...
            {   
                /**
                 * Permet de redirigÃ© le flot de controle vers le thread dÃ©diÃ©
                 * Ã  java FX. Si on ne passe pas par runLater, une exception est gÃ©nÃ©rÃ©e.
                 **/
    ...
    /**
     * @param symbole joueur dont on veut savoir s'il a gagnÃ© ou pas
     * @return vrai si le joueur a gagnÃ© faut sinon
     */
